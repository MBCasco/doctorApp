...
public class RegistroActivity extends AppCompatActivity
{
    ...
    public void registrarUsuarios()
    {
        ...
        final String correo = extra.getString("correo");
        final String cedula = extra.getString("cedula");
        final String nombre = extra.getString("nombre");
        String clave = extra.getString("clave");
        etCorreo     = findViewById(R.id.etCorreo); etCorreo.setText(correo);
        etCedula      = findViewById(R.id.etCedula); etCedula.setText(cedula);
        etClave    = findViewById(R.id.etClave); etClave.setText(clave);
        etNombre      = findViewById(R.id.etNombre); etNombre.setText(nombre);
